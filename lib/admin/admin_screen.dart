...
class AdminScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Map<String, bool> convertToMap(List<TextEditingController> controllers) {
      ...
      options[questionController
          .optioncontrollers[
              int.parse(questionController.CorrectAnswerController.text) - 1]
          .text] = true;
      return options;
    }
    ...
    void addQuestion() {
      final String QuestionText =
          questionController.QuestionControllerText.text;
      final List<String> options = questionController.optioncontrollers
          .map((controller) => controller.text)
          .toList();
      final Map<String, bool> Options =
          convertToMap(questionController.optioncontrollers);
      DBconnect().addQuestion(
          Question(id: '1', title: QuestionText, options: Options),
          QuizCategory);
