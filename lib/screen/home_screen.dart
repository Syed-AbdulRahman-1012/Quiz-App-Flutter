    ...
    if (click && index >= length - 1) {
      showDialog(
          ...
          builder: ((ctx) => ResultBox(
              questionLength: length, onPressed: startOver, result: score)));
    } else {
      setState(() {
        if (click == true) {
          click = false;
                    ...
                    Padding(
                      ...
                      child: SizedBox(
                        ...
                        child: ElevatedButton(
                            onPressed: () =>
                                incremntIndex(extractedData.length),
                            style: const ButtonStyle(
                              foregroundColor:
                                  WidgetStatePropertyAll(Color(0xFF121212)),
