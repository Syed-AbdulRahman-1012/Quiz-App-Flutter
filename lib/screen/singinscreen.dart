...
class _LoginScreenState extends State<LoginScreen> {
  late Map<String, dynamic> userScores =
      {}; // Initialize userScores as an empty map
    ...
    try {
      ...
      if (user != null) {
        ...
        final response = await http.get(Uri.parse(
            'https://quizapp-19185-default-rtdb.firebaseio.com/scores/$userId.json?auth=$idToken'));
